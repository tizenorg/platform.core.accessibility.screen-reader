 ...
 * @param remove_preceding_read_commands  determines if the preceding read commands has to be removed from reading queue
 ...
 * if it can be discarded by other reading requests or not and.
 *
 * @param text_to_speak a text that would be read by the Text To Speach (TTS) service
 * @param remove_preceding_read_commands  determines if the preceding read commands has to be removed from reading queue
 * @param discardable determines if this reading request can be discarded by subsequent reading requests or not
